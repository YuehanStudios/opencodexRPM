...
export const de = {
  ...
  "models.rpmLabel": "RPM-Limit",
  "models.rpmValue": "{value} Anf./Min.",
  "models.rpmInvalid": "RPM muss eine positive Zahl sein",
  "models.edit": "Bearbeiten",
  "models.apply": "Anwenden",
  "models.rpmSummary": "{rpm} Anf. / {window}s",
  "models.rpmCollapse": "Einklappen",
  "models.rpmField": "Anforderungen",
  "models.rpmFieldHint": "Maximal zulässige Anforderungen im Fenster.",
  "models.rpmWindow": "Fenster (s)",
  "models.rpmWindowHint": "Fensterlänge in Sekunden (mindestens 1).",
  "models.rpmWindowInvalid": "Fenster muss mindestens 1 Sekunde betragen",
  "models.rpmEven": "Gleichmäßige Verteilung",
  "models.rpmEvenHint": "Anforderungen gleichmäßig über das Fenster verteilen statt anfangs einen Burst zuzulassen.",
  "models.rpmRestartNote": "Änderungen starten den Proxy neu, um wirksam zu werden.",
